...
public class Controller {
    ...
    private void addStudent() {
        if (txtName.getText().isEmpty() || txtCourse.getText().isEmpty() || cbYear.getValue() == null) {
            showAlert("Please fill in all fields (Name, Course, and Year Level) before adding a student.");
            return;
        }
    ...
    private void updateStudent() {
        if (selectedId == -1) {
            showAlert("Please select a student from the table first before clicking Update.");
            return;
        }

        if (txtName.getText().isEmpty() || txtCourse.getText().isEmpty() || cbYear.getValue() == null) {
            showAlert("Please ensure Name, Course, and Year Level are completely filled out.");
            return;
        }
    ...
    private void deleteStudent() {
        if (selectedId == -1) {
            showAlert("Please select a student from the table first before clicking Delete.");
            return;
        }
